...
module.exports = {
    ...
    execute: async (bot, msg, args, cfg) => {
        ...
        try {
            ...
            return 'I was unable to access that URL. Please try another.'
        }
        if (!head.headers['content-type'] || !head.headers['content-type'].startsWith('image'))
            return "I couldn't find an image at that URL. Make sure it's a direct link (ends in .jpg or .png for example)."
        ...
        try {
            ...
            return 'There was a problem checking that image. Please try another.'
        }
