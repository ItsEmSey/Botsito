...
module.exports = {
    ...
    usage: cfg => [
        'brackets <name> [brackets] - if brackets are given, change the ' + cfg.lang + "'s brackets, if not, simply echo the current ones",
    ...
    execute: async (bot, msg, args, cfg) => {
        ...
        let member = await bot.db.getMember({user_id:msg.author.id, name})
        ...
        let brackets = msg.content
            .slice(msg.content.indexOf(name) + name.length + 1)
            .trim()
            .split('text')
