...
module.exports = {
    ...
    usage: cfg => ['remove <name> - Unregister the named ' + cfg.lang + ' from your list', 'remove * - Unregister ALL of your ' + cfg.lang + 's (requires confirmation)'],
    permitted: () => true,
    groupArgs: true,
    execute: async (bot, msg, args, cfg) => {
        ...
        if (args[0] == '*') {
            ...
            await bot.db.deleteMemberIds(msg.author.id)
