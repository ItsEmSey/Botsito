...
module.exports = {
    ...
    usage: cfg => [
        'tag <name> [tag] - if tag is given, change the ' + cfg.lang + "'s tag, if not, show the current one.",
    ...
    execute: async (bot, msg, args, cfg) => {
        ...
        if (args[0] == '*') {
            ...
            await bot.db.clearTags(msg.author.id) //bot.db.query('UPDATE Members SET tag = null WHERE user_id = $1', [msg.author.id])
